    ...
    <div class="grid grid-cols-3 gap-4 mb-10 max-w-xl mx-auto items-end">
        ...
        <div class="text-center">
            <div class="card p-4 rounded-2xl" style="border-top: 4px solid #c0c0c0;">
                <div class="text-3xl mb-2 font-bold text-cool-gray">2</div>
        ...
        <div class="text-center -mt-6">
            <div class="card p-4 rounded-2xl shadow-lg" style="border-top: 4px solid #fbbf24;">
                <div class="text-4xl mb-2 font-bold text-yellow-500">1</div>
        ...
        <div class="text-center mt-4">
            <div class="card p-4 rounded-2xl" style="border-top: 4px solid #cd7f32;">
                <div class="text-3xl mb-2 font-bold text-amber-700">3</div>
    ...
    <div class="card overflow-hidden">
        ...
        <div class="divide-y divide-gray-50">
            ...
            <div class="text-center py-16">
                ...
                <a href="{{ route('modules.index') }}" class="btn-primary mt-4 inline-flex">Mulai Belajar & Kumpulkan Poin</a>
            </div>
            @endif
        </div>
    </div>
