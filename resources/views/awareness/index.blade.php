...
<section class="bg-melon-tint py-16">
    <div class="container-cf text-center">
        <div class="badge-peach mb-4 inline-flex">Edukasi Perlindungan</div>
            ...
            <div>
                ...
                <div class="space-y-3" id="pinjol-checklist">
                    ...
                    <label class="flex items-center gap-3 p-4 bg-subtle-ash rounded-xl cursor-pointer hover:bg-red-50 transition-colors group" x-data="{checked:false}">
                        ...
                        <span x-show="checked" class="ml-auto text-red-600 text-xs font-bold">Bahaya!</span>
                    </label>
                    @endforeach
                </div>
...
<section class="section-alt">
    <div class="container-cf">
        <div class="text-center mb-10">
            ...
            <p class="text-cool-gray max-w-xl mx-auto">House edge memastikan platform selalu menang dalam jangka panjang.</p>
        </div>
        ...
        <div class="card-peach p-8 rounded-2xl">
            ...
            <p class="text-sm text-terra-cotta mt-4 font-medium">Selisih: Rp 43 Juta — Pilihan ada di tanganmu.</p>
        </div>
    </div>
</section>
